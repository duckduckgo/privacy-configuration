 ...
 */
export type AndroidV5Config = ConfigV5<number> & {
 ...
 */
export type GenericV5Config = ConfigV5<string>;

export type LegacyConfig = GenericV5Config;
export type LegacyAndroidConfig = AndroidV5Config;
